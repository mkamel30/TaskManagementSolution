                ...
                <Collapsible asChild key={bakery.id} open={openGroupId === bakery.id} onOpenChange={() => handleToggleGroup(bakery.id)}>
                  <>
                    ...
                    >
                      ...
                      <TableCell>
                        {bakery.operation_date ? format(new Date(bakery.operation_date), 'dd.MM.yyyy', { locale: ar }) : 
                         bakery.quota_date ? format(new Date(bakery.quota_date), 'dd.MM.yyyy', { locale: ar }) : '-'}
                      </TableCell>
